...
const (
	...
	Insights_GetFindings_FullMethodName               = "/deps_dev.v3alpha.Insights/GetFindings"
	Insights_GetFindingsBatch_FullMethodName          = "/deps_dev.v3alpha.Insights/GetFindingsBatch"
...
type InsightsClient interface {
	...
	GetFindings(ctx context.Context, in *GetFindingsRequest, opts ...grpc.CallOption) (*Findings, error)
	// GetFindingsBatch performs GetFindings requests for a batch of
	// packages/versions. Large result sets may be paginated.
	GetFindingsBatch(ctx context.Context, in *GetFindingsBatchRequest, opts ...grpc.CallOption) (*FindingsBatch, error)
...
func (c *insightsClient) GetPackage(ctx context.Context, in *GetPackageRequest, opts ...grpc.CallOption) (*Package, error) {
	...
	out := new(Package)
	err := c.cc.Invoke(ctx, Insights_GetPackage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetVersion(ctx context.Context, in *GetVersionRequest, opts ...grpc.CallOption) (*Version, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Version)
	err := c.cc.Invoke(ctx, Insights_GetVersion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetVersionBatch(ctx context.Context, in *GetVersionBatchRequest, opts ...grpc.CallOption) (*VersionBatch, error) {
	...
	err := c.cc.Invoke(ctx, Insights_GetVersionBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetFindings(ctx context.Context, in *GetFindingsRequest, opts ...grpc.CallOption) (*Findings, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Findings)
	err := c.cc.Invoke(ctx, Insights_GetFindings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetFindingsBatch(ctx context.Context, in *GetFindingsBatchRequest, opts ...grpc.CallOption) (*FindingsBatch, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FindingsBatch)
	err := c.cc.Invoke(ctx, Insights_GetFindingsBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetRequirements(ctx context.Context, in *GetRequirementsRequest, opts ...grpc.CallOption) (*Requirements, error) {
	...
	err := c.cc.Invoke(ctx, Insights_GetRequirements_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetDependencies(ctx context.Context, in *GetDependenciesRequest, opts ...grpc.CallOption) (*Dependencies, error) {
	...
	err := c.cc.Invoke(ctx, Insights_GetDependencies_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetDependents(ctx context.Context, in *GetDependentsRequest, opts ...grpc.CallOption) (*Dependents, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Dependents)
	err := c.cc.Invoke(ctx, Insights_GetDependents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetCapabilities(ctx context.Context, in *GetCapabilitiesRequest, opts ...grpc.CallOption) (*Capabilities, error) {
	...
	err := c.cc.Invoke(ctx, Insights_GetCapabilities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetProject(ctx context.Context, in *GetProjectRequest, opts ...grpc.CallOption) (*Project, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Project)
	err := c.cc.Invoke(ctx, Insights_GetProject_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetProjectBatch(ctx context.Context, in *GetProjectBatchRequest, opts ...grpc.CallOption) (*ProjectBatch, error) {
	...
	err := c.cc.Invoke(ctx, Insights_GetProjectBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetProjectPackageVersions(ctx context.Context, in *GetProjectPackageVersionsRequest, opts ...grpc.CallOption) (*ProjectPackageVersions, error) {
	...
	err := c.cc.Invoke(ctx, Insights_GetProjectPackageVersions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetAdvisory(ctx context.Context, in *GetAdvisoryRequest, opts ...grpc.CallOption) (*Advisory, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Advisory)
	err := c.cc.Invoke(ctx, Insights_GetAdvisory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) GetSimilarlyNamedPackages(ctx context.Context, in *GetSimilarlyNamedPackagesRequest, opts ...grpc.CallOption) (*SimilarlyNamedPackages, error) {
	...
	err := c.cc.Invoke(ctx, Insights_GetSimilarlyNamedPackages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*QueryResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QueryResult)
	err := c.cc.Invoke(ctx, Insights_Query_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) PurlLookup(ctx context.Context, in *PurlLookupRequest, opts ...grpc.CallOption) (*PurlLookupResult, error) {
	...
	err := c.cc.Invoke(ctx, Insights_PurlLookup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) PurlLookupBatch(ctx context.Context, in *PurlLookupBatchRequest, opts ...grpc.CallOption) (*PurlLookupBatchResult, error) {
	...
	err := c.cc.Invoke(ctx, Insights_PurlLookupBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *insightsClient) QueryContainerImages(ctx context.Context, in *QueryContainerImagesRequest, opts ...grpc.CallOption) (*QueryContainerImagesResult, error) {
	...
	err := c.cc.Invoke(ctx, Insights_QueryContainerImages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InsightsServer interface {
	...
	// GetFindings evaluates a specified package or version and returns
	// findings which are relevant to safe dependency management.
	GetFindings(context.Context, *GetFindingsRequest) (*Findings, error)
	// GetFindingsBatch performs GetFindings requests for a batch of
	// packages/versions. Large result sets may be paginated.
	GetFindingsBatch(context.Context, *GetFindingsBatchRequest) (*FindingsBatch, error)
	// GetRequirements returns the requirements for a given version in a
	// system-specific format. Requirements are currently available for
	// Cargo, Go, Maven, npm, NuGet, PyPI, and RubyGems.
	//
...
func (UnimplementedInsightsServer) GetVersionBatch(context.Context, *GetVersionBatchRequest) (*VersionBatch, error) {
	return nil, status.Error(codes.Unimplemented, "method GetVersionBatch not implemented")
}
func (UnimplementedInsightsServer) GetFindings(context.Context, *GetFindingsRequest) (*Findings, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFindings not implemented")
}
func (UnimplementedInsightsServer) GetFindingsBatch(context.Context, *GetFindingsBatchRequest) (*FindingsBatch, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFindingsBatch not implemented")
}
...
func (UnimplementedInsightsServer) GetProjectBatch(context.Context, *GetProjectBatchRequest) (*ProjectBatch, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProjectBatch not implemented")
}
func (UnimplementedInsightsServer) GetProjectPackageVersions(context.Context, *GetProjectPackageVersionsRequest) (*ProjectPackageVersions, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProjectPackageVersions not implemented")
}
...
func (UnimplementedInsightsServer) GetSimilarlyNamedPackages(context.Context, *GetSimilarlyNamedPackagesRequest) (*SimilarlyNamedPackages, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSimilarlyNamedPackages not implemented")
}
...
func (UnimplementedInsightsServer) PurlLookup(context.Context, *PurlLookupRequest) (*PurlLookupResult, error) {
	return nil, status.Error(codes.Unimplemented, "method PurlLookup not implemented")
}
func (UnimplementedInsightsServer) PurlLookupBatch(context.Context, *PurlLookupBatchRequest) (*PurlLookupBatchResult, error) {
	return nil, status.Error(codes.Unimplemented, "method PurlLookupBatch not implemented")
}
func (UnimplementedInsightsServer) QueryContainerImages(context.Context, *QueryContainerImagesRequest) (*QueryContainerImagesResult, error) {
	return nil, status.Error(codes.Unimplemented, "method QueryContainerImages not implemented")
}
...
func _Insights_GetFindings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFindingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InsightsServer).GetFindings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Insights_GetFindings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InsightsServer).GetFindings(ctx, req.(*GetFindingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Insights_GetFindingsBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFindingsBatchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InsightsServer).GetFindingsBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Insights_GetFindingsBatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InsightsServer).GetFindingsBatch(ctx, req.(*GetFindingsBatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Insights_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Insights_GetFindings_Handler,
		},
		{
			MethodName: "GetFindingsBatch",
			Handler:    _Insights_GetFindingsBatch_Handler,
		},
		{
